...
static TreeItem treeitem_server[] = {
	{N_("Settings"),     19, NULL },
	{ NULL }
};
...
static ConfItem confitems[] = {
	...
	{"server/enable",   T_TOGGLEBUTTON, "servercheckbutton"},
	{"server/host",     T_ENTRY,        "serverhostentry"},
	{"server/port",     T_ENTRY,        "serverportentry"},
	{"server/password", T_ENTRY,        "serverpwentry"},
