...
extern gchar *conf_get_string_default(const gchar *key);
extern gboolean conf_get_bool(const gchar *key);
extern gboolean conf_get_bool_default(const gchar *key);
extern gint conf_get_int(const gchar *key);
extern gint conf_get_int_default(const gchar *key);
extern gdouble conf_get_float(const gchar *key);
extern gdouble conf_get_float_default(const gchar *key);
